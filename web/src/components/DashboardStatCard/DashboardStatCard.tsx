...
const DashboardStatCard = ({
    ...
    return (
        <div className="p-6 bg-gray-100 dark:bg-gray-800 bg-opacity-70 dark:bg-opacity-70 border-2 border-gray-200 dark:border-gray-800 rounded-lg hoverItem duration-200">
