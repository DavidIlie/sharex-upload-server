...
const AppLayout = ({ children }: LayoutProps): JSX.Element => {
    ...
    return (
        <>
            ...
            <Background />
            <div className="flex flex-col justify-between min-h-screen text-black dark:text-white pageBackground backdrop-filter backdrop-blur-sm dark:backdrop-blur-sm">
                <ThemeSwitcher />
                {children}
